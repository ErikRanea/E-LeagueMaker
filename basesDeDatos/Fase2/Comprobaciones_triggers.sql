...
INSERT INTO jugadores (cod, nombre,apellido, rol, salario, nacionalidad, fecha_nacimiento, nickname, cod_equipo) VALUES (5, 'jugador5', 'apellido5', 'entrenador', 7000, 'espa�a', '10-11-2002', 'shadow', 1 );
INSERT INTO jugadores (cod, nombre,apellido, rol, salario, nacionalidad, fecha_nacimiento, nickname, cod_equipo) VALUES (6, 'jugador6', 'apellido6', 'entrenador', 5000, 'jupiter', '10-11-2005', 'shadow', 1 );
----al inggresar el jugador 7 se dispara el trigger verificar la tabla jugadores--------
/*Informe de error -
ORA-20001: No se pueden agregar m�s de 6 jugadores a un equipo
ORA-06512: en "EQDAW05.CONTROLAR_MAX_JUGADOR", l�nea 9
ORA-04088: error durante la ejecuci�n del disparador 'EQDAW05.CONTROLAR_MAX_JUGADOR'*/
INSERT INTO jugador (cod, nombre,apellido, rol, salario, nacionalidad, fecha_nacimiento, nickname, cod_equipo) VALUES (7, 'jugador7', 'apellido7', 'entrenador', 9000, 'venus', '10-11-2001', 'shadow', 1 );
...
INSERT INTO jornadas (cod, n_jornada, fecha, cod_competicion, cod_juego) VALUES (8, 2, TO_DATE('2024/04/27', 'YYYY/MM/DD'),302, 3 )
Error en la l�nea de comandos : 20 Columna : 13
Informe de error -
Error SQL: ORA-20001: No se puede crear una competici�n
        con un n�mero impar de equipos
ORA-06512: en "EQDAW05.CONTROLAR_EQUIPOS_IMPARES", l�nea 10
ORA-04088: error durante la ejecuci�n del disparador 'EQDAW05.CONTROLAR_EQUIPOS_IMPARES'*/

/*5 Si se quiere hacer un insert tiene que haber m�nimo 1 entrenador */

INSERT INTO equipos (nombre, fecha_fundacion) VALUES ('peruvian',TO_DATE('2014/04/27', 'YYYY/MM/DD'));

INSERT INTO jugadores (nombre, apellido, rol, salario, nacionalidad, fecha_nacimiento, nickname, cod_equipo) VALUES ('Aitor', 'Rodriguez', 'flex', 1250, 'Euskadi',TO_DATE('2000/04/27', 'YYYY/MM/DD'),'Aitorro', 7);
...
Informe de error -
Error SQL: ORA-20001: El equipo debe tener al menos un entrenador para poder dar de alta en la tabla de PUNTOS_EQUIPOS
ORA-06512: en "EQDAW05.CONTROLAR_ENTRENADOR_MIN", l�nea 12
ORA-04088: error durante la ejecuci�n del disparador 'EQDAW05.CONTROLAR_ENTRENADOR_MIN'*/

/*6. Cuando hay insert de enfrentamiento, condicional if ganalocal suma a local !ganaLocal     
...
/*7. Cuando hacemos una insert de un salario minimo a un jugador nos da el error */

INSERT INTO Jugadores ( nombre, apellido, salario, nacionalidad, fecha_nacimiento, nickname, rol, cod_Equipo)
VALUES ('Erik', 'Ranea', 500, 'Espa�a', TO_DATE('03/12/2000','DD/MM/YYYY'), 'Dele', 'Suport', 03);


/*Informe de error -
Error SQL: ORA-20001: No se puede ingresar un salario inferior a 1134
ORA-06512: en "EGIBIDE.CONTROLAR_SALARIO_MIN_JUGADORES", l�nea 4
ORA-04088: error durante la ejecuci�n del disparador 'EGIBIDE.CONTROLAR_SALARIO_MIN_JUGADORES'*/

/*8. Comrpobamos que el salario maximo del equipo no sobrepasa los 200000 */

INSERT INTO Jugadores ( nombre, apellido, salario, nacionalidad, fecha_nacimiento, nickname, rol, cod_Equipo)
VALUES ('Fernando', 'Porras', 1200, 'Espa�a', TO_DATE('03/12/2000','DD/MM/YYYY'), 'Dele', 'Suport', 03);
...
/*Informe de error -
Error SQL: ORA-20001: El salario total del equipo excede el l�mite de 200,000.
ORA-06512: en "EGIBIDE.CONTROLAR_SALARIO_MAX_EQUIPO", l�nea 9
ORA-04088: error durante la ejecuci�n del disparador 'EGIBIDE.CONTROLAR_SALARIO_MAX_EQUIPO'*/
