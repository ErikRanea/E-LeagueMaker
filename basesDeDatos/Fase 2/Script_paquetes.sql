...
CREATE OR REPLACE PACKAGE crud_Equipos AS 
    ...
    PROCEDURE modificar_equipo(p_cod IN equipos.cod%TYPE, p_nombre IN equipos.nombre%TYPE, p_fecha_fundacion IN equipos.fecha_fundacion%TYPE);
...
CREATE OR REPLACE PACKAGE crud_Patrocinadores AS 
    TYPE tipo_cursor IS REF CURSOR;
    PROCEDURE insertar_Patrocinadores(p_nombre IN patrocinadores.nombre%TYPE, p_cod_equipo IN patrocinadores.cod_equipo%TYPE);
    PROCEDURE borrar_Patrocinadores(p_cod IN patrocinadores.cod_patrocinador%TYPE);
    PROCEDURE modificar_Patrocinadores(p_cod IN patrocinadores.cod_patrocinador%TYPE, p_nombre IN patrocinadores.nombre%TYPE);
    FUNCTION consultar_Patrocinadores(p_cod IN patrocinadores.cod_patrocinador%TYPE) RETURN tipo_cursor;
...
CREATE OR REPLACE PACKAGE BODY crud_Patrocinadores IS
    ...
    FUNCTION consultar_Patrocinadores(p_cod IN patrocinadores.cod_patrocinador%TYPE) 
    RETURN tipo_cursor
    IS
        v_cursor tipo_cursor;
    BEGIN
...
CREATE OR REPLACE PACKAGE crud_Jugadores AS 
    TYPE tipo_cursor IS REF CURSOR;
    PROCEDURE insertar_Jugadores(p_nombre IN jugadores.nombre%TYPE, p_apellido IN jugadores.apellido%TYPE, p_rol IN jugadores.rol%TYPE, p_salario IN jugadores.salario%TYPE, p_nacionalidad IN jugadores.nacionalidad%TYPE, p_fecha_nacimiento IN jugadores.fecha_nacimiento%TYPE, p_nickname IN jugadores.nickname%TYPE, p_cod_equipo IN jugadores.cod_equipo%TYPE);
    PROCEDURE borrar_Jugadores(p_cod IN jugadores.cod%TYPE);
    PROCEDURE modificar_Jugadores(p_cod IN jugadores.cod%TYPE, p_nombre IN jugadores.nombre%TYPE, p_apellido IN jugadores.apellido%TYPE, p_rol IN jugadores.rol%TYPE, p_salario IN jugadores.salario%TYPE, p_nacionalidad IN jugadores.nacionalidad%TYPE, p_fecha_nacimiento IN jugadores.fecha_nacimiento%TYPE, p_nickname IN jugadores.nickname%TYPE);
    FUNCTION consultar_Jugadores(p_cod IN jugadores.cod%TYPE) RETURN tipo_cursor;
END crud_Jugadores;
/
...
CREATE OR REPLACE PACKAGE BODY crud_Jugadores IS
    ...
    IS
    BEGIN
        INSERT INTO Jugadores (nombre, apellido, rol, salario, nacionalidad, fecha_nacimiento, nickname, cod_equipo)
        VALUES (p_nombre, p_apellido, p_rol, p_salario, p_nacionalidad, p_fecha_nacimiento, p_nickname, p_cod_equipo);
...
CREATE OR REPLACE PACKAGE crud_Staffs AS 
    TYPE tipo_cursor IS REF CURSOR;
    PROCEDURE insertar_Staffs(p_nombre IN Staffs.nombre%TYPE, p_apellido IN Staffs.apellido%TYPE, p_puesto IN Staffs.puesto%TYPE, p_salario IN Staffs.salario%TYPE, p_cod_equipo IN Staffs.cod_equipo%TYPE);
    PROCEDURE borrar_Staffs(p_cod IN Staffs.cod%TYPE);
    PROCEDURE modificar_Staffs(p_cod IN Staffs.cod%TYPE, p_nombre IN Staffs.nombre%TYPE, p_apellido IN Staffs.apellido%TYPE, p_puesto IN Staffs.puesto%TYPE, p_salario IN Staffs.salario%TYPE);
...
CREATE OR REPLACE PACKAGE crud_Usuarios AS 
    TYPE tipo_cursor IS REF CURSOR;
    PROCEDURE insertar_Usuarios(p_nickname IN Usuarios.nickname%TYPE, p_contrase�a IN Usuarios.contrase�a%TYPE, p_es_admin IN Usuarios.es_admin%TYPE);
    PROCEDURE borrar_Usuarios(p_cod_usuarios IN Usuarios.cod_usuario%TYPE);
    PROCEDURE modificar_Usuarios(p_cod_usuarios IN Usuarios.cod_usuario%TYPE, p_nickname IN Usuarios.nickname%TYPE, p_contrase�a IN Usuarios.contrase�a%TYPE, p_es_admin IN Usuarios.es_admin%TYPE);
    FUNCTION consultar_Usuarios(p_cod_usuarios IN Usuarios.cod_usuario%TYPE) RETURN tipo_cursor;
END crud_Usuarios;
/
...
CREATE OR REPLACE PACKAGE BODY crud_Usuarios IS
    ...
    BEGIN
        ...
        VALUES (p_nickname, p_contrase�a, p_es_admin);
...
CREATE OR REPLACE PACKAGE crud_Puntos_equipos AS 
    TYPE tipo_cursor IS REF CURSOR;
    PROCEDURE insertar_Puntos_equipos(p_cod_equipo IN Puntos_equipos.cod_equipo%TYPE, p_cod_competicion IN Puntos_equipos.cod_competicion%TYPE, p_puntos IN Puntos_equipos.puntos%TYPE);
    PROCEDURE borrar_Puntos_equipos(p_cod_equipo IN Puntos_equipos.cod_equipo%TYPE, p_cod_competicion IN Puntos_equipos.cod_competicion%TYPE);
    PROCEDURE modificar_Puntos_equipos(p_cod_equipo IN Puntos_equipos.cod_equipo%TYPE, p_cod_competicion IN Puntos_equipos.cod_competicion%TYPE, p_puntos IN Puntos_equipos.puntos%TYPE);
    FUNCTION consultar_Puntos_equipos(p_cod_equipo IN Puntos_equipos.cod_equipo%TYPE, p_cod_competicion IN Puntos_equipos.cod_competicion%TYPE) RETURN tipo_cursor;
...
CREATE OR REPLACE PACKAGE BODY crud_Puntos_equipos IS
    ...
    FUNCTION consultar_Puntos_equipos(p_cod_equipo IN Puntos_equipos.cod_equipo%TYPE, p_cod_competicion IN Puntos_equipos.cod_competicion%TYPE) 
    RETURN tipo_cursor
    IS
        v_cursor tipo_cursor;
    BEGIN
